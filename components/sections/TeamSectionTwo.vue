...
<template>
  <div class="team-section-2 section-padding section-bg fix">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div v-for="(member, index) in teamMembers" :key="index" class="team-line-box bor-top bor-bottom wow fadeInUp"
            ...
            <div class="social-profile">
              <ul>
                ...
                <li><a href="https://www.instagram.com/tekvionsystems/
" target="_blank"><i class="fab fa-instagram"></i></a></li>
                <li><a href="https://www.linkedin.com/in/tekvion-systems-78916a37b" target="_blank"><i
