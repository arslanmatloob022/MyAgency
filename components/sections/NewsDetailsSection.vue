            ...
            <div class="news-post-details">
                ...
                <div class="post-content">
                  ...
                  <div class="hilight-text mt-4">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                      <path d="M7.71428 20.0711H0.5V5.64258H14.9286V20.4531L9.97665 30.3568H3.38041L8.16149 20.7947L8.5233 20.0711H7.71428Z" stroke="#FF3B00"></path>
                      <path d="M28.2846 20.0711H21.0703V5.64258H35.4989V20.4531L30.547 30.3568H23.9507L28.7318 20.7947L29.0936 20.0711H28.2846Z" stroke="#FF3B00"></path>
                    </svg>
                  </div>
                  <p class="pt-5">
                    Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore of magna aliqua. Ut enim ad minim veniam, made of owl the quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea dolor commodo consequat. Duis aute irure and dolor in reprehenderit.
              ...
              <div class="row tag-share-wrap mt-4 mb-5">
                <div class="col-lg-8 col-12">
                  <div class="tagcloud">
                    <span>Tags:</span>
                    <NuxtLink to="/news/details">Security</NuxtLink>
                    <NuxtLink to="/news/details">UI/UX Desing</NuxtLink>
                    <NuxtLink to="/news/details">Digital</NuxtLink>
                  </div>
                </div>
              ...
              <div class="comments-area">
                ...
                <div class="blog-single-comment d-flex gap-4 pt-4 pb-5">
                  ...
                  <div class="content">
                    <div class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                      <div class="con">
                        <h5><NuxtLink to="/news/details">Leslie Alexander</NuxtLink></h5>
                        <span>February 10, 2025 at 2:37 pm</span>
                      </div>
                      <NuxtLink to="/news/details" class="reply">Reply</NuxtLink>
                    </div>
                    <p class="mt-30 mb-4">
                ...
                <div class="blog-single-comment d-flex gap-4 pt-4 pb-5">
                  ...
                  <div class="content">
                    <div class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                      <div class="con">
                        <h5><NuxtLink to="/news/details">Ralph Edwards</NuxtLink></h5>
                        <span>February 10, 2025 at 2:37 pm</span>
                      </div>
                      <NuxtLink to="/news/details" class="reply">Reply</NuxtLink>
                    </div>
                  ...
                  <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                      <button type="submit" class="main-button">
                        <span class="theme-btn"> post comment </span><span class="arrow-btn"><i class="icon-arrow-right"></i></span>
                      </button>
                    </div>
                  </div>
                </form>
            ...
            <div class="main-sidebar sticky-style">
              ...
              <div class="single-sidebar-widget">
                ...
                <div class="news-widget-categories">
                  <ul>
                    <li><NuxtLink to="/news/details">Digital Agency</NuxtLink> <span>(7)</span></li>
                    <li><NuxtLink to="/news/details">Business</NuxtLink> <span>(4)</span></li>
                    <li class="active"><NuxtLink to="/news/details">Digital Product</NuxtLink> <span>(5)</span></li>
                    <li><NuxtLink to="/news/details">Social Marketing</NuxtLink> <span>(3)</span></li>
                    <li><NuxtLink to="/news/details">System</NuxtLink> <span>(6)</span></li>
                  </ul>
                </div>
              </div>
              <div class="single-sidebar-widget">
              ...
              <div class="single-sidebar-widget">
                ...
                <div class="news-widget-categories">
                  <div class="tagcloud">
                    <NuxtLink to="/news/details">Security</NuxtLink>
                    <NuxtLink to="/news/details">Business</NuxtLink>
                    <NuxtLink to="/news/details">Digital</NuxtLink>
                    <NuxtLink to="/news/details">Technology</NuxtLink>
                    <NuxtLink to="/news/details">Change</NuxtLink>
                    <NuxtLink to="/news/details">Video</NuxtLink>
                    <NuxtLink to="/news/details">UI/UX Design</NuxtLink>
                    <NuxtLink to="/news/details">Startup</NuxtLink>
                    <NuxtLink to="/news/details">Services</NuxtLink>
                  </div>
                </div>
              </div>
            </div>
